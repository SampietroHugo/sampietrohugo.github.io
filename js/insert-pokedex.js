document.addEventListener("DOMContentLoaded", () => {
    ...
    async function initializePokedex() {
        try {
            const response = await fetch('/json/pokedex.json');
    ...
    function createPokemonCard(pokemon) {
        ...
        if (pokemon.altForm) {
            ...
            `;
            altImage = `
                <img src="${pokemon.altForm.sprite}" class="pokedex-card-image pokedex-card-image-alt">
            `;
        }
        ...
        card.innerHTML = `
            <div class="pokedex-card-image-wrapper">
                <img src="${pokemon.image}" class="pokedex-card-image pokedex-card-image-default">
                ${altImage}
                ${shinyTradeIcons}
                ${altIcon}
            </div>
